...
from tmd.constants import AVOGADRO, DEFAULT_PRESSURE, DEFAULT_TEMP, NBParamIdx
from tmd.fe.free_energy import AbsoluteFreeEnergy, HostConfig, InitialState
...
# from tmd.md.minimizer import fire_minimize_host
...
def get_initial_state(water_pdb, mol, ff, seed, nb_cutoff, use_hmr, lamb):
    ...
    # read water system
    host_config = build_host_config(water_pdb, ff.water_ff, padding=0.2)
