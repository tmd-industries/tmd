...
from tmd.fe.free_energy import HREXParams, InitialState, MDParams, SimulationResult
...
from tmd.fe.rbfe import estimate_relative_free_energy_bisection_hrex_impl
...
if __name__ == "__main__":
    ...
    # python -u examples/water_sampling_hrex.py --water_pdb tmd/testsystems/water_exchange/bb_0_waters.pdb --ligand_sdf tmd/testsystems/water_exchange/bb_centered_espaloma.sdf --n_frames 2000 --use_hmr 1
    test_hrex()
