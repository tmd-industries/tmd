...
def test_get_water_idxs(num_lig_atoms):
    ...
    test_idxs = exchange_mover.get_water_idxs(all_group_idxs)
    np.testing.assert_array_equal(np.array(test_idxs), all_group_idxs)
