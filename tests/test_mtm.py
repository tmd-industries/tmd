...
from tmd.md import enhanced
from tmd.md.barostat.moves import NPTMove
from tmd.md.moves import OptimizedMTMMove, ReferenceMTMMove
from tmd.md.states import CoordsVelBox
from tmd.potentials import NonbondedInteractionGroup, nonbonded
...
@pytest.mark.skip("No OE License")
@pytest.mark.nightly
def test_optimized_MTM():
    ...
    nb_idx, nb_wl_potential = next((i, pot) for i, pot in enumerate(ubps) if isinstance(pot, NonbondedInteractionGroup))

    nb_params = params[nb_idx]
