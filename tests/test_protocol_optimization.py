...
from tmd._vendored.pymbar.testsystems import HarmonicOscillatorsTestCase
from tmd.fe.bar import DEFAULT_MAXIMUM_ITERATIONS, DEFAULT_RELATIVE_TOLERANCE, DEFAULT_SOLVER_PROTOCOL
from tmd.fe.rbfe import DEFAULT_MD_PARAMS, estimate_relative_free_energy_bisection
from tmd.ff import Forcefield
from tmd.optimize.protocol import (
...
def test_rebalance_initial_protocol():
    ...
    initial_protocol = np.linspace(0, 1, 40)
...
def test_greedy_overlap_on_st_vacuum():
    ...
    bisection_result = estimate_relative_free_energy_bisection(
        ...
        None,
        n_windows=48,
        md_params=replace(DEFAULT_MD_PARAMS, n_frames=100),
        min_overlap=2 / 3,
    )
