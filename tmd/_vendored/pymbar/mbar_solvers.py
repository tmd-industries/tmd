...
#
# * Set force_no_jax=True, avoids memory issues due to Jax Jit
##############################################################################
...
from tmd._vendored.pymbar.utils import ensure_type, check_w_normalized, ParameterError

logger = logging.getLogger(__name__)

use_jit = False
force_no_jax = True  # Temporary until we can make a proper setting to enable/disable by choice
try:
    #### JAX related imports
    if force_no_jax:
