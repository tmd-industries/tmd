...
def infer_node_vals_and_errs_networkx(
    ...
    """Version of :py:func:`tmd.fe.mle.infer_node_vals_and_errs` that accepts a directed networkx graph.
    ...
    n_bootstrap, seed:
        See documentation for :py:func:`tmd.fe.mle.infer_node_vals_and_errs`
    ...
    # Add all of the original nodes, ensuring that we are warned about nodes becoming disconnected
    ...
    if len(connected_components) > 1:
        warnings.warn("Graph has multiple connected components, computing MLE on largest component")
