...
# example usage:
# python tmd/ff/amber_converter.py --input_path amber99sbildn.xml --method "nonbonded"
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Convert an AMBER protein XML to a tmd FF")
