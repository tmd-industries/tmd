...
from tmd.potentials import BoundPotential
...
class NVTMove(Move[CoordsVelBox]):
    ...
    def move(self, x: CoordsVelBox) -> CoordsVelBox:
        ...
        ctxt = custom_ops.Context_f32(x.coords, x.velocities, x.box, self.integrator_impl, self.bound_impls)
        return self._steps(ctxt)

    def _steps(self, ctxt: "custom_ops.Context_f32") -> CoordsVelBox:
