...
2. This implementation grew out of previous protocol optimization approaches considered:
...
from tmd.fe.reweighting import interpret_as_mixture_potential
...
def log_weights_from_mixture(u_kn: ArrayLike, f_k: ArrayLike, N_k: ArrayLike) -> Array:
    ...
    * u_kn[k, n] = u_k(xs[n)
    ...
    """
    # TODO: merge with tmd/fe/reweighting.py::interpret_as_mixture_potential ?
    f_k = jnp.asarray(f_k)
